...
import com.yildizan.newsfrom.model.Filter;
import com.yildizan.newsfrom.model.News;
import com.yildizan.newsfrom.repository.NewsRepository;
import com.yildizan.newsfrom.repository.OldNewsRepository;
...
public class NewsController {
    ...
    private News assign(Object[] obj) {
        ...
        // from news
        try {
            var news = (com.yildizan.newsfrom.entity.News) obj[0];
            ...
            var news = (com.yildizan.newsfrom.entity.OldNews) obj[0];
            model.setId(news.getId());
            model.setTitle(news.getTitle());
            model.setDescription(news.getDescription());
            model.setLink(news.getLink());
